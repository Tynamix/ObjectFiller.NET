...
{
    public class DateTimeMinMax : IRandomizerPlugin<DateTime>, IRandomizerPlugin<DateTime?>
    {
        private readonly DateTime _earliestDate;
        private readonly DateTime _latestDate;

        public DateTimeMinMax(DateTime earliestDate)
            : this(earliestDate, DateTime.Now)
        {
        }

        public DateTimeMinMax(DateTime earliestDate, DateTime latestDate)
        {
